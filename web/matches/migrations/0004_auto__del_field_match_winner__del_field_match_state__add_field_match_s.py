...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('matches_match', 'winner')

        # Deleting field 'Match.state'
        db.delete_column('matches_match', 'state')

        # Adding field 'Match.started'
        db.add_column('matches_match', 'started',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Match.ended'
        db.add_column('matches_match', 'ended',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Match.state'
        raise RuntimeError("Cannot reverse this migration. 'Match.state' and its values cannot be restored.")
        # Deleting field 'Match.started'
        db.delete_column('matches_match', 'started')

        # Deleting field 'Match.ended'
        db.delete_column('matches_match', 'ended')
