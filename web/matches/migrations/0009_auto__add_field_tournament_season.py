...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tournament.season'
        db.add_column('matches_tournament', 'season',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['matches.Season']),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Tournament.season'
        db.delete_column('matches_tournament', 'season_id')
