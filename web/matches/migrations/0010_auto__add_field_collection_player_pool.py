...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Collection.player_pool'
        db.add_column('matches_collection', 'player_pool',
                      self.gf('django.db.models.fields.IntegerField')(default=5),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Collection.player_pool'
        db.delete_column('matches_collection', 'player_pool')
