...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Collection.group_identifier'
        db.add_column('matches_collection', 'group_identifier',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Collection.group_identifier'
        db.delete_column('matches_collection', 'group_identifier')
