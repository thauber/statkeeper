...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Tournament.season'
        raise RuntimeError("Cannot reverse this migration. 'Tournament.season' and its values cannot be restored.")
    models = {
        'matches.action': {
