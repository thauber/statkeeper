...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Season'
        db.create_table('matches_season', (
            ...
            ('league', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['matches.League'])),
        ))
        db.send_create_signal('matches', ['Season'])

    def backwards(self, orm):
        # Deleting model 'Season'
        db.delete_table('matches_season')
