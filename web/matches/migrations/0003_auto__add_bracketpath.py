...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BracketPath'
        db.create_table('matches_bracketpath', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('prev_match', self.gf('django.db.models.fields.related.ForeignKey')(related_name='prve_paths', to=orm['matches.Match'])),
            ('qualifier', self.gf('django.db.models.fields.TextField')(max_length=63)),
            ('next_match', self.gf('django.db.models.fields.related.ForeignKey')(related_name='next_paths', to=orm['matches.Match'])),
        ))
        db.send_create_signal('matches', ['BracketPath'])

    def backwards(self, orm):
        # Deleting model 'BracketPath'
        db.delete_table('matches_bracketpath')
