...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tournament.style'
        db.add_column('matches_tournament', 'style',
                      self.gf('django.db.models.fields.CharField')(default='GSL', max_length=63),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Tournament.style'
        db.delete_column('matches_tournament', 'style')
