...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MatchPlayer.identifier'
        db.add_column('matches_matchplayer', 'identifier',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'BracketPath.identifier'
        db.add_column('matches_bracketpath', 'identifier',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'MatchPlayer.identifier'
        db.delete_column('matches_matchplayer', 'identifier')

        # Deleting field 'BracketPath.identifier'
        db.delete_column('matches_bracketpath', 'identifier')
    ...
    models = {
        ...
        'matches.bracketpath': {
            ...
            'prev_match': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'prev_paths'", 'to': "orm['matches.Match']"}),
            'qualifier': ('django.db.models.fields.TextField', [], {'max_length': '63'})
        },
        'matches.collection': {
            'Meta': {'unique_together': "(('tournament', 'slug'),)", 'object_name': 'Collection'},
            'group_identifier': ('django.db.models.fields.IntegerField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '63'}),
            'player_pool': ('django.db.models.fields.IntegerField', [], {}),
        ...
        'matches.tournament': {
            ...
            'season': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['matches.Season']"}),
            'slug': ('django.db.models.fields.CharField', [], {'max_length': '63'}),
            'start_date': ('django.db.models.fields.DateTimeField', [], {}),
